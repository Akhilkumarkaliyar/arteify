...
if(!function_exists('custompaging'))
{
    function custompaging($cur_page,$no_of_paginations,$previous_btn,$next_btn,$first_btn,$last_btn)
    {
        ...
        //===========view parts===========//
        $msg .= "<div class='text-right'><div class='dataTables_paginate paging_simple_numbers' style='width:100%;padding:20px 0px 0'>
                    <ul class='pagination'>";
                    ...
                    {
                        $msg .= "<li class='paginate_button  disabled '><a href='#'><i class='fa fa-angle-left'></i></a></li>";
                    }
                    for ($i = $start_loop; $i <= $end_loop; $i++)
                    {
                        if ($cur_page == $i)
                            ...
                            $msg .= "<li p='$i' class=' paginate_button  next '><a>{$i}</a></li>";
                    }
                    ...
                    {
                        $msg .= "<li class='paginate_button  disabled '><a href='#'><i class='fa fa-angle-right'></i></a></li>";
                    }
                    ...
                    $total_string = "<span class='totalfront pull-left' a='$no_of_paginations'>Page <b>" . $cur_page . "</b> of <b>$no_of_paginations</b></span>";
