...
define('DB_PASSWORD','');
define('DB_DATABASE','Inrozgar'); //centralized
define('ADMIN_EMAIL','akhil.kumar@scheppendsolutions.com');

define('DEFAULT_TITLE','Inrozgar');
...
define('LI_URL','');
define('GP_URL','');
define('IMG_URL','http://ec2-13-233-172-180.ap-south-1.compute.amazonaws.com:5000/images/');
...
define('SITE_URL_ORI','');
define('GOOGLE_MAP_API','AIzaSyCxS50H7b7SuCAsATse_C4L0x7Nccpk3TM');
