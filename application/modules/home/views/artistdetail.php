<!-- Infor Model -->
				...
				<div class="col-lg-9">
					<div class="classes-details">
						<div class="classes-preview">
							<img src="<?php echo base_url();?>front_assets/img/classes/big.jpg" alt="">
						</div>
						<div class="row">
							<div class="col-lg-8">
								<h2>Yoga Therapy</h2>
						...
						<div class="row mb-5">
							<div class="col-lg-5">
								<img src="<?php echo base_url();?>front_assets/img/classes/classes-details.png" alt="">
							</div>
							<div class="col-lg-7">
					...
					<div class="classes-other-slider owl-carousel">
						<div class="classes-item">
							<div class="ci-img">
								<img src="<?php echo base_url();?>front_assets/img/classes/1.jpg" alt="">
							</div>
							<div class="ci-text">
						...
						<div class="classes-item">
							<div class="ci-img">
								<img src="<?php echo base_url();?>front_assets/img/classes/2.jpg" alt="">
							</div>
							<div class="ci-text">
							...
							<div class="ci-bottom">
								<div class="ci-author">
									<img src="<?php echo base_url();?>front_assets/img/classes/author/2.jpg" alt="">
									<div class="author-text">
										<h6>Victoria Webb</h6>
										<p>Yoga Trainer</p>
									</div>
						...
						<div class="classes-item">
							<div class="ci-img">
								<img src="<?php echo base_url();?>front_assets/img/classes/3.jpg" alt="">
							</div>
							<div class="ci-text">
								<h4>Yoga Therapy</h4>
								<div class="ci-metas">
							...
							<div class="ci-bottom">
								<div class="ci-author">
									<img src="<?php echo base_url();?>front_assets/img/classes/author/3.jpg" alt="">
									<div class="author-text">
										<h6>Victoria Webb</h6>
										<p>Yoga Trainer</p>
									</div>
					...
					<ul class="comment-list">
						<li>
							<img src="<?php echo base_url();?>front_assets/img/classes/author/3.jpg" class="comment-pic" alt="">
							...
							<ul class="comment-sub-list">
								<li>
									<img src="<?php echo base_url();?>front_assets/img/classes/author/2.jpg" class="comment-pic" alt="">
									<div class="comment-text">
						...
						<li>
							<img src="<?php echo base_url();?>front_assets/img/classes/author/1.jpg" class="comment-pic" alt="">
							<div class="comment-text">
								<h3>Lori Gonzales</h3>
								<div class="comment-date"><i class="material-icons">alarm_on</i>June 28, 2019 at 3:18 pm</div>
								<p>Just practicing yoga for more than 3 months, I dropped from 64 kg to 58 kg. I have used many weight loss measures such as medication, diet, but the effects are slow and low. </p>
	...
	<div class="gallery-section">
		<div class="gallery-slider owl-carousel">
			<div class="gs-item">
				<img src="<?php echo base_url();?>front_assets/img/gallery/1.jpg" alt="">
				<div class="gs-hover">
					<i class="fa fa-instagram"></i>
					<p>ahana.yoga</p>
				</div>
			...
			<div class="gs-item">
				<img src="<?php echo base_url();?>front_assets/img/gallery/2.jpg" alt="">
				<div class="gs-hover">
					<i class="fa fa-instagram"></i>
					<p>ahana.yoga</p>
				</div>
			...
			<div class="gs-item">
				<img src="<?php echo base_url();?>front_assets/img/gallery/3.jpg" alt="">
				<div class="gs-hover">
					<i class="fa fa-instagram"></i>
					<p>ahana.yoga</p>
				</div>
			...
			<div class="gs-item">
				<img src="<?php echo base_url();?>front_assets/img/gallery/4.jpg" alt="">
				<div class="gs-hover">
					<i class="fa fa-instagram"></i>
					<p>ahana.yoga</p>
				</div>
			...
			<div class="gs-item">
				<img src="<?php echo base_url();?>front_assets/img/gallery/5.jpg" alt="">
				<div class="gs-hover">
					<i class="fa fa-instagram"></i>
					<p>ahana.yoga</p>
				</div>
			...
			<div class="gs-item">
				<img src="<?php echo base_url();?>front_assets/img/gallery/6.jpg" alt="">
				<div class="gs-hover">
					<i class="fa fa-instagram"></i>
					<p>ahana.yoga</p>
				</div>
